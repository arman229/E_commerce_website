                ...
                <div key={item.id} className={'p-4'}>
                    <div className={'grid grid-cols-12 gap-6'}>
                        ...
                        <div className={'lg:col-span-7 col-span-10 '}>
                            ...
                            <Image src={item.images[0]} alt="Product Image" className={'w-full'} width={800}
                                   height={600}/>
                        </div>
                    ...
                    <div>
                        ...
                        <div className={'grid grid-cols-12 py-4'}>
                            <div className={'md:col-span-3 col-span-12'}>
                                <h1 className={'text-[#666] font-bold md:text-lg text-xl uppercase'}>product
                                    details </h1>
                            </div>
                            <div className={'md:col-span-9 col-span-12'}>
                                <p className={'  md:text-md text-sx'}>
                                    {item.productDetails}
                                </p>
                            </div>
                        </div>
