            ...
            <footer className=" pt-8 mt-4 px-4  ">
                <div className=" ">
                    <div className="grid grid-cols-12 justify-between gap-y-8 ">
                        <div className=" col-span-12  sm:col-span-5 lg:col-span-4 ">
                            <div className='  flex   gap-4 flex-col justify-around h-full  '>
                                <Link href={"/"}>
                                    <Image src={azeinth} className=" lg:h-30 md:h-24 lg:w-auto  h-16  w-32 h-full w-auto" alt='not shows'/>
                                </Link>
                                <p className={'leading-7 text-lg my-4 [&:not(:first-child)]:mt-6'}> Small, artisan label that offers a thoughtfully curated collection of high quality everyday essentials made.</p>
                    ...
                    <div className={'flex  justify-between gap-3 flex-wrap p-3  '}>
                        ...
                        <p>Design by. <span className={'font-bold'}>Arman Ashraf</span></p>
                        <p>Code by. <Link href={'https://github.com/arman229/E_commerce_website.git'} className={' hover:underline font-bold'}>arman229 on github </Link></p>
                    </div>
                </div>
            </footer>
        </div>
