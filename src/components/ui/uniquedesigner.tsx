...
const Uniquedesigner:React.FC = () => {
    return (
        <div className={'my-8 py-4'}>
            <div className={'flex'}>
                <div className={'lg:w-1/2'}></div>
                <div className={'lg:w-1/2  text-[#212121] scroll-m-20 text-xl font-bold tracking-tight lg:text-4xl'}>Unique and Authentic Vintage Designer Jewellery
                </div>
            </div>
            <div className={'flex    py-4 px-2 flex-col lg:flex-row'}>
                ...
                <div className={'lg:w-1/2 w-full flex gap-4 flex-col md:flex-row py-4'}>
                    <div className={'lg:w-2/5 w-full self-center  '}><Image className={'mx-auto  transform hover:scale-110 transition-transform duration-300 ease-in-out'} src={girlimage} alt={'not shows'}/></div>
